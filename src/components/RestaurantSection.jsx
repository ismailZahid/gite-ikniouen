    ...
    const menu = [
        {
            ...
            items: [
                {
                    fr: "Salade du potager (selon saison)",
                    en: "Garden salad (seasonal greens)",
                    es: "Ensalada del huerto (según la temporada)",
                    price: "45 MAD"
                },
                {
                    fr: "Zaalouk (aubergines grillées)",
                    en: "Roasted eggplant dip",
                    es: "Zaalouk (berenjena asada)",
                    price: "45 MAD"
                },
                {
                    fr: "Harira traditionnelle",
                    en: "Traditional Moroccan soup",
                    es: "Harira tradicional",
                    price: "40 MAD"
                },
                {
                    fr: "Pain beldi au feu de bois & huile d’olive",
                    en: "Wood-fired bread & local olive oil",
                    es: "Pan bereber al horno de leña y aceite de oliva local",
                    price: "25 MAD"
                },
            ]
        },
            ...
            items: [
                {
                    ...
                    es: "Tajine de cordero con ciruelas",
                    price: "110 MAD"
                },
                {
                    fr: "Tajine de poulet au citron confit et olives",
                    en: "Chicken tagine with preserved lemon & olives",
                    es: "Tajine de pollo con limón confitado y aceitunas",
                    price: "95 MAD"
                },
                {
                    fr: "Couscous végétarien du potager",
                    en: "Garden vegetable couscous",
                    es: "Cuscús vegetariano del huerto",
                    price: "85 MAD"
                },
                {
                    fr: "Brochettes du jour, salade et pain beldi",
                    en: "Daily grilled skewers with salad & bread",
                    es: "Pinchos del día con ensalada y pan bereber",
                    price: "100 MAD"
                },
                {
                    fr: "Omelette berbère à la tomate",
                    en: "Amazigh tomato omelet",
                    es: "Tortilla bereber con tomate",
                    price: "60 MAD"
                },
            ]
        },
        ...
        },
        {
            ...
            items: [
                ...
                {
                    fr: "Pâtisseries marocaines assorties",
                    en: "Moroccan pastries selection",
                    es: "Dulces marroquíes variados",
                    price: "40 MAD"
                },
                {
                    fr: "Yaourt au miel et amandes",
                    en: "Yogurt with honey & almonds",
                    es: "Yogur con miel y almendras",
                    price: "35 MAD"
                },
                {
                    fr: "Fruits de saison du jardin",
                    en: "Seasonal fruits from the garden",
                    es: "Frutas de temporada del jardín",
                    price: "25 MAD"
                },
            ]
        },
            ...
            items: [
                {
                    ...
                    es: "Menú completo (Entrada + Plato + Postre)",
                    price: "130 MAD / pers."
                },
                {
                    fr: "Menu enfant (–12 ans)",
                    en: "Child menu (–12 yrs)",
                    es: "Menú infantil (–12 años)",
                    price: "65 MAD / niño"
                },
                {
                    fr: "Dîner “à la carte” selon saison",
                    en: "À la carte dinner (seasonal)",
                    es: "Cena “a la carta” según la temporada",
                    price: "—"
                },
            ]
        },
    ...
    return (
        <section id="restaurant" className="relative py-20 text-slate-900 dark:text-slate-100">
            ...
            <div className="absolute inset-0 -z-10 overflow-hidden">
                ...
                <div
                    className="absolute inset-0 bg-gradient-to-b from-white/80 via-white/50 to-white/90 dark:from-black/70 dark:via-black/40 dark:to-black/70"/>
            </div>
            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div
                    className="grid md:grid-cols-2 gap-10 backdrop-blur-sm bg-white/50 dark:bg-black/30 p-6 rounded-2xl shadow-md">
                    {menu.map((section) => (
                        <div key={section.id}>
                            ...
                            <ul className="space-y-2">
                                {section.items.map((it, i) => (
                                    <li key={i}
                                        className="flex justify-between border-b border-amber-200 dark:border-emerald-900 pb-1">
                                        <span className="text-slate-800 dark:text-slate-100">{it[lang]}</span>
                                        <span
                                            className="text-amber-700 dark:text-emerald-300 font-semibold">{it.price}</span>
                                    </li>
                                ))}
                            </ul>
                        </div>
